                            ...
                            <tbody className="divide-y divide-slate-100">
                                {history.map(t => (
                                    <tr key={t.id}>
                                        ...
                                        <td className="px-3 py-2 text-right font-medium text-green-600 privacy-hidden">
                         ...
                         >
                            <div className="flex items-center justify-between pointer-events-none gap-4">
                                ...
                                <div className="flex items-center space-x-1 pointer-events-auto flex-shrink-0">
                                    <p className="font-bold text-lg text-slate-800 whitespace-nowrap privacy-hidden">{formatCurrency(accountBalances.get(acc.id) || 0)}</p>
                                    <button 
                               ...
                               <div
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex flex-col mt-1">
                                        ...
                                        <span className={`text-3xl font-bold privacy-hidden ${currentViewBalance < 0 ? 'text-red-500' : 'text-slate-900'}`}>
                                            {formatCurrency(currentViewBalance)}
                                        </span>
                                        {!selectedCardId && hasLinkedCards && (
                                            <span className={`text-sm ${cardDisplayColor} font-medium mt-1`}>
                                                {cardDisplayLabel}: <span className="privacy-hidden">{formatCurrency(Math.abs(currentAccountTotalCardDebt))}</span>
                                            </span>
                                        )}
                                    </div>
                                </div>
                                    ...
                                    paginatedTransactions.map(t => {
                                        ...
                                        return (
                                            <tr key={t.id} className="hover:bg-gray-50">
                                                ...
                                                <td className={`px-4 py-4 text-right font-bold ${displayProps.color} privacy-hidden`}>
