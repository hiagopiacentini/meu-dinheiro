        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 xl:col-span-8 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-slate-200"><p className="text-sm text-slate-500 font-medium">Receitas no Período</p><p className="text-2xl font-bold text-green-600 privacy-hidden">{formatCurrency(periodIncome)}</p></div>
                    <div className="bg-white p-4 rounded-xl border border-slate-200"><p className="text-sm text-slate-500 font-medium">Despesas no Período</p><p className="text-2xl font-bold text-red-600 privacy-hidden">{formatCurrency(periodExpenses)}</p></div>
                    <div className="bg-white p-4 rounded-xl border border-slate-200"><p className="text-sm text-slate-500 font-medium">Saldo</p><p className={`text-2xl font-bold privacy-hidden ${periodIncome - periodExpenses >= 0 ? 'text-slate-800' : 'text-red-600'}`}>{formatCurrency(periodIncome - periodExpenses)}</p></div>
                </div>
                                ...
                                {paginatedTransactions.length === 0 ? (
                                    ...
                                    paginatedTransactions.map(t => {
                                        ...
                                        <tr key={t.id} className="hover:bg-gray-50">
                                            ...
                                            <td className={`px-4 py-3 text-right font-bold ${displayProps.color} privacy-hidden`}>
